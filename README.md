...
[![HitCount](http://hits.dwyl.com/fredgrott/base_appbar.svg)](http://hits.dwyl.com/fredgrott/base_appbar)![Maintainer](https://img.shields.io/badge/maintainer-theMaintainer-blue)[![GitHub forks](https://img.shields.io/github/forks/fredgrott/base_appbar.svg?style=social&label=Fork&maxAge=2592000)](https://github.com/fredgrott/base_appbar/network/)[![GitHub stars](https://img.shields.io/github/stars/fredgrott/base_appbar.svg?style=social&label=Star&maxAge=2592000)](https://github.com/fredgrott/base_appbar/stargazers/)[![GitHub followers](https://img.shields.io/github/followers/fredgrott.svg?style=social&label=Follow&maxAge=2592000)](https://github.com/fredgrott?tab=followers)[![GitHub contributors](https://img.shields.io/github/contributors/fredgrott/base_appbar.svg)](https://github.com/fredgrott/base_appbar/graphs/contributors/)[![GitHub issues](https://img.shields.io/github/issues/fredgrott/base_appbar.svg)](https://github.com/fredgrott/base_appbar/issues/)[![GitHub issues-closed](https://img.shields.io/github/issues-closed/fredgrott/base_appbar.svg)](https://github.com/fredgrott/base_appbar/issues?q=is%3Aissue+is%3Aclosed)

A Flutter demo of an animated appbar.

And, of course, showing the animated appbar aesthetic. This project is part of the flutter deep dive:
...
```bash
git clone https://github.com/fredgrott/base_appbar.git
```
